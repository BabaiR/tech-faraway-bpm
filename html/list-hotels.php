                ...
                <div class="card">
                    <div class="card-block">
                        <div class="row">
                            ...
                            <div class="col-md-6"><a href="form-hotels.php"><button class="btn btn-warning btn-circle"
                            ...
                            <table id="example23" class="display nowrap table table-hover table-striped table-bordered"
                                ...
                                <tbody>
                                    ...
                                    if (isset($_GET['island'])) {
                                        ...
                                        $hotels_info = json_decode(getHotels($island_id, $conn));
                                        ...
                                        foreach ($hotels_info as $value) {
                                            ...
                                            echo '<td><a href="list-hotels-info.php?island=' . $island_id . '&hotel=' . $value->HotelID . '"><i class="mdi mdi-eye" style="font-size:24px"></i></a> <a href="form-hotels.php?island=' . $island_id . '&hotel=' . $value->HotelID . '&mode=edit"><i class="mdi mdi-pencil-circle" style="font-size:24px"></i></a> <a href="javascript:void(0);" class="subtract" data-value="'. $value->HotelID .'"><i class="mdi mdi-delete-circle" style="font-size:24px"></i></a> </td>';
                                            echo "</tr>";
                                        }
                                    }
                                    else {
                                        $hotels_info = json_decode(getHotels("123_Foo_Bar_123_Foo", $conn));
                                        foreach ($hotels_info as $value) {
