...
<!--                                    <input type="hidden" value="0" name="currentFormID" id="currentFormID">-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group"> <label>Neil Island</label> 
                                ...
                                <span class="form41Span">
                                    ...
                                    if ($len_roomblocking != 0) {
                                        for ($i = 0; $i < $len_roomblocking; $i++) {
                                            ...
                                            <span class="form41Row" data-id="0" data-checkin="0">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group"> 
                                                            ...
                                                            <div class="input-group">
                                                                <select class="form-control custom-select HotelSelectedForm41 recheckInHide" disabled="true">
                                                                    <option></option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group"> 
                                                            ...
                                                            <div class="input-group">
                                                                <select class="form-control custom-select MealPlanForm41 recheckInHide">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group"> 
                                                            ...
                                                            <select class="form-control custom-select RoomSelectedForm41 recheckInHide">
                                                                <option></option>
                                                            </select>
                                                        </div>
                                                    </div>
                                    ...
                                    if ($len_itenarary_info != 0) {
                                        for ($i = 0; $i < $len_itenarary_info; $i++) {
                                            ...
                                            <span class="form5Row" data-id="<?php echo $i ?>">
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group"> <label for="firstName1">Select Date</label>
                                                            <div class="input-group"> 
