        ...
        <table width="750" cellspacing="0" cellpadding="5" align="center">
            ...
            <tr>
                <td style="font-family:cambria; font-size:11.5px; background:#FFFF00"><ol><li><span style="color: #009900"><strong>Full payment and confirmation with details by <?php echo date("dS F Y", strtotime($guest_count[0]->CutOff)); ?> </strong></span></li>
                        ...
                        <li><span style="color: #009900"><strong>ID proof's</strong> of all guest travelling for getting Sound & Light Show Tickets</span></li>
...
?>
                                        ...
                                        <tr>
                                            ...
                                            if ($ExtraAdultRate != 0 && $ExtraAdult != 0) {
                                                ?>
                                                <td valign="top" style="border-top:none; font-family:cambria; font-size:11.5px"><strong>Extra adult with Mattress</strong></td>
                                                <td valign="top" style="border-top:none; border-left:none; font-family:cambria; font-size:11.5px"><?php
                                               ...
                                               $total+=($ExtraAdult * $ExtraAdultRate);
                                                ...
                                                {
                                                ?>
                                             <tr>   <td valign="top" style="border-top:none; font-family:cambria; font-size:11.5px"><strong>Extra child with Mattress</strong></td>
                                                <td valign="top" style="border-top:none; border-left:none; font-family:cambria; font-size:11.5px"><?php
...
//                                                                        echo intval($ExtraAdult) . " x " . intval($ExtraAdultRate) . " + " . intval($ExtraChildWithMat) . " x " . intval($ExtraChildWithMatRate)
                                        ...
                                        <tr>
                                            ...
                                            if ($ExtraChildRate != 0 && $ExtraChild != 0) {
                                                ?>
                                                <td valign="top" style="border-top:none; font-family:cambria; font-size:11.5px"><strong>Extra child without Mattress (5-11 yrs)</strong></td>
                                                <td valign="top" style="border-top:none; border-left:none; font-family:cambria; font-size:11.5px"><?php
...
<br/>                                    <table width="750" cellspacing="0" cellpadding="5" align="center" border="1">
                                        ...
                                        <tr>
                                            <td valign="top" style="border-top:none; font-family:cambria; font-size:11.5px"><strong>GST Number</strong></td>
                                        <td valign="top" style="border-top:none; border-left:none; font-family:cambria; font-size:11.5px">35AACCF5694A1ZS</td>
                                        </tr>
                                    </table><br/>
                   <?php
           }
