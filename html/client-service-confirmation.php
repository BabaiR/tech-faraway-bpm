                                ...
                                <td valign="top" style="border-left:none; font-family:cambria; font-size:11.5px;">
                                    ...
                                    <span class="stripLastPlus">
                                        <?php echo (intval($guest_count[0]->Occupancy) + intval($guest_count[0]->SingleOccupancy)+ intval($guest_count[0]->SingleOccFamily)) > 0 && (intval($guest_count[0]->Occupancy) + intval($guest_count[0]->SingleOccupancy)+ intval($guest_count[0]->SingleOccFamily))< 10 ? " 0" . (intval($guest_count[0]->Occupancy) + intval($guest_count[0]->SingleOccupancy)+ intval($guest_count[0]->SingleOccFamily)) . " Adults +" : (intval($guest_count[0]->Occupancy) + intval($guest_count[0]->SingleOccupancy)+ intval($guest_count[0]->SingleOccFamily))>=10 ? (intval($guest_count[0]->Occupancy) + intval($guest_count[0]->SingleOccupancy)+ intval($guest_count[0]->SingleOccFamily)) . " Adults +":"" ?>
                                            <?php echo (($guest_count[0]->ExtraAdult > 0) && ($guest_count[0]->ExtraAdult < 10)) ? " 0" . $guest_count[0]->ExtraAdult . " Extra Mattress +" : $guest_count[0]->ExtraAdult >= 10?$guest_count[0]->ExtraAdult :"" ?>
...
?>
    ...
    <table width="600" cellspacing="0" cellpadding="5" align="center">
        ...
        <tr>
            <td colspan="2" style="font-family:cambria; font-size:11.5px;">All cancellations are to be communicated in writing. <i>Cancellation policy will be applicable <u>ON FULL TOUR PRICE (transport, hotels & other services) </u>, in spite of any Flight / Train cancellation / Weather Conditions / Covid Conditions has affected the operation of the Tours.</i></td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" style="font-family:cambria; font-size:11.5px;"><ul><li style="background:#999999; padding:5px;"><strong>No refund for cancellations on bookings from 15th December - 15th January</strong></li>
                    ...
                    <li><span style="color:#009900; font-size:12.5px"><strong><u>Cancellations outside the cancellation policy will attract a 5% Cancellation penalty.</u></strong></span></li>
                    <!--<li><span style="color: #0070c0; font-size:12.5px;"><strong><u>Contact number of guest</u></strong></span></li>-->
                    <li>No refunds would be offered on the Private (Speed Catamaran) tickets, if already purchased as per our contract with the Private Ferry operator, once tickets have been booked. We are a bulk purchaser and our contract terms are separate from their regular cancellation policy.</li>
                    <li>NO REFUND for any unutilized services example : meals, entrance fee, optional, hotel, sightseeing, transportation (surface). All refunds due will be kept in a credit shelf for utilization for future travel date.</li>
                </ul>
            </td>
        </tr>
    </table>
    ...
    <table width="600" cellspacing="0" cellpadding="5" align="center" >
		...
		<!--<tr>
            <td style="font-family:cambria; font-size:11.5px;"><strong>Mr. Jeffrey Frost : 8900957773
                </strong></td>
        </tr>-->
