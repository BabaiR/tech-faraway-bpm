...
<table width="700" cellspacing="0" cellpadding="5" align="center">
  ...
  <tr>
   ...
   <tr>
    <?php $stop_date = date('dS F , Y', strtotime($guest_count[0]->Departure . ' +1 day'));?>
     ...
     <td><strong>To:</strong> 
      <?php 
        // echo isset($closure[0]->Agent) && !empty($closure[0]->Agent)  ? json_decode(getAgent($closure[0]->Agent,$conn))[0]->CompanyName : ""  ; 
        if (isset($closure[0]->Agent) && !empty($closure[0]->Agent)) {
           if (json_decode(getAgent($closure[0]->Agent,$conn))[0]->AgentID == 18) {
             echo "TC Tours Limited";
           }else{
            echo json_decode(getAgent($closure[0]->Agent,$conn))[0]->CompanyName;
           }
        }else{
          echo "";
        }
        ...
        <tr>
         <td>&nbsp;</td>
          <td><strong>Address:</strong>
            <?php echo json_decode(getAgent($closure[0]->Agent,$conn))[0]->Address; ?>
          </td>
        </tr>
    <?php 
      }
 ...
 <table width="700" cellspacing="0" cellpadding="5" align="center">
  ...
  <tr id="oneinner">
    ...
    <td rowspan="2" align="center" valign="middle"><strong><?php echo $packagewo = isset($closure[0]->PackageAmount) ? $closure[0]->PackageAmount: ""?></strong></td>
  </tr>
  <tr id="oneinner">
  ...
  <?php  
        ...
        if (json_decode(getAgent($closure[0]->Agent,$conn))[0]->AgentID == 18 || json_decode(getAgent($closure[0]->Agent,$conn))[0]->AgentID == 157) {
          
         if (isset($packagewo) && !empty($packagewo)) {
             $sgst=round(($packagewo *2.5/100),0);
             $cgst=round(($packagewo *2.5/100),0);
           }
           else{
            $cgst= "";
            $sgst= "";
           }
           $totalamt = $packagewo + $cgst + $sgst;

           ?>
             <tr id="oneinner">
            <td colspan="2" valign="top" align="right"><strong>SGST @ 2.5%</strong></td>
            <td valign="top" align="center"><strong><?php echo $sgst; ?></strong></td>
          </tr>
          <tr id="oneinner">
            <td colspan="2" valign="top" align="right"><strong>CGST @ 2.5%</strong></td>
            <td valign="top" align="center"><strong><?php echo $cgst; ?></strong></td>
          </tr>
          <?php  
        }else{ 
            if (isset($packagewo) && !empty($packagewo)) {
               $gstb=round(($packagewo *5/100),0);
             }
             else{
              $gstb= "";
             }

             $totalamt = $packagewo + $gstb;

          ?>
            <tr id="oneinner">
            <td colspan="2" valign="top" align="right"><strong>IGST @ 5%</strong></td>
  ...
  <!-- <tr id="oneinner">
    <td colspan="2" valign="top" align="right"><strong>IGST @ 5%</strong></td>
    <td valign="top" align="center"><strong><?php echo isset($closure[0]->PackageAmount) ? $utgst=round(($closure[0]->PackageAmount *5/100),0) : "";?></strong></td> 
  </tr> -->
  ...
  <tr id="oneinner">
    ...
    <td valign="top" align="center"><strong>
      <?php 
      // echo isset($closure[0]->PackageAmount)? ceil(($closure[0]->PackageAmount+$utgst)) : "";
      echo $totalamt;
      ?>
  ...
  <tr id="oneinner">
   ...
   <!--  <tr id="oneinner">
    ...
    <td valign="top" align="center"><strong>
      <?php 
      // echo isset($closure[0]->PackageAmount)? ceil(($closure[0]->PackageAmount)) : "";
      echo $totalamt;
      ?>
